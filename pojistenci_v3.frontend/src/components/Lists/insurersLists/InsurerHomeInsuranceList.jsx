...
const InsurerHomeInsuranceList = ({ insurerId }) => {
    ...
    useEffect(() => {
        apiClient
            .get(`/homeinsurances/insurer/${insurerId}`)
            .then((response) => {
            ...
            <div className="card rounded-0">
                <div className="card-header">
                    <div style={{ height: "110px" }}>
                        <h1 className="text-center mb-3">Pojištění nemovitostí</h1>
                        <div className="row fw-bold pb-2">
                            ...
                            <div className="col-md-2 sortable bla" onClick={() => handleSort('propertyAddress')} style={{ cursor: 'pointer' }}>
                ...
                <div className="card-body" style={{ flexGrow: 1, overflowY: "auto", height: "calc(100vh - 242px)" }}>
                    <div className="row">
...
export default InsurerHomeInsuranceList;
