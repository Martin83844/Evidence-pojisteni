...
{
	/// <summary>
	/// DTO pro aktualizaci záznamu o škodě na nemovitosti.
	/// Obsahuje informace, které lze měnit při aktualizaci existujícího záznamu škody spojeného s pojištěním nemovitosti.
	/// </summary>
	public class UpdateHomeInsuranceDamageRecordDTO
	{
		/// <summary>
