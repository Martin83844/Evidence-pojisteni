...
{
	/// <summary>
	/// DTO pro vytvoření záznamu o nehodě spojené s pojištěním vozidla.
	/// Obsahuje informace potřebné pro inicializaci nového záznamu škody spojeného s pojištěním vozidla.
	/// </summary>
	public class CreateCarInsuranceAccidentRecordDTO
	{
		/// <summary>
